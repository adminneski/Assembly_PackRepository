...
uses
  Windows, StdCtrls, DbCtrls, DB, Messages, Graphics, Classes,
  Controls, SysUtils, VDBConsts;
...
//  //CORREÇÃO SETTEXT ENTRE ITEMS E VALUES - AP2 - 03 10 2022
//  FDataLink.Edit;
//  FDataLink.Field.Value := ComboText;
//  inherited Change;
    ...
    if Style <> csDropDown then begin
      ...
      try
        if Value = '' then I := -1 else
          if FEnableValues then
          begin
            // Se Estiver Habilitar a Property EnableValues.
            // Pega o Valor para Buscar o IndexOf pelo Valor do Field Sempre
            // mesmo com Evento GetText Linkado
            I := Values.IndexOf(Field.AsString)
          end
          else
          begin
            // Se NÃO Estiver Habilito a Property EnableValues.
            // Verifica se Existe o Evento GetText Linkado
            if Assigned(Field.OnGetText) then
            begin
              // Se o Evento estiver Linkado Busca na lista Items pelo valor da variavel [Value] que esta recebendo o valor do Text.
              I := Items.IndexOf(Value)
            end
            else
            begin
              // Se o Evento NÃO estiver Linkado Busca na lista Values pelo valor da variavel [Value] que esta recebendo o valor do Field.
