...
var
  PredifinedPropsClassList: TClassList;
...
function TPredifinedPropsEh.PropertyAdded(Component: TComponent; const PropPath: String): Boolean;
begin
  Result := False;
end;

function TPredifinedPropsEh.PropertyDeleted(Component: TComponent; const PropPath: String): Boolean;
begin
  Result := False;
end;
...
function TPredifinedActiveControlEh.PropertyAdded(Component: TComponent; const PropPath: String): Boolean;
begin
...
function TPredifinedActiveControlEh.PropertyDeleted(Component: TComponent; const PropPath: String): Boolean;
begin
  if PropPath = '<P>.ActiveControl'
...
function TPredifinedPosPropertiesEh.PropertyAdded(Component: TComponent; const PropPath: String): Boolean;
begin
  if PropPath = '<P>.Top'
    then FTopAdded := True;
  if PropPath = '<P>.Left'
...
function TPredifinedPosPropertiesEh.PropertyDeleted(Component: TComponent; const PropPath: String): Boolean;
begin
  if PropPath = '<P>.Top'
...
initialization
  PredifinedPropsClassList := TClassList.Create;
