...
{$IFDEF EH_LIB_16} Themes, {$ENDIF}
  Grids, IniFiles,
  DBVertGridsEh, PivotGridsEh, PlannersEh, PrnDbgEh,
...
//    PrintDBGridEh1: TPrintDBGridEh;
    ...
    procedure actToPdfExecute(Sender: TObject);
...
procedure TForm1.actToPdfExecute(Sender: TObject);
var
  AFilename: String;
  Path: String;
...
//  SetEhLibDebugFocus(2000);
  ...
  PrintDBGridEh1 := TPrintDBGridEh.Create(Self);
