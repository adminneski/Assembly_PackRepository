object MemTableDesignFrame: TMemTableDesignFrame
  Left = 0
  Top = 0
  Width = 608
  Height = 475
  ...
  object ActionList1: TActionList
    ...
    object actLoadDataSet: TAction
      Caption = 'Load from file...'
      OnExecute = actLoadDataSetExecute
    end
    object actSaveDataSet: TAction
      Caption = 'Save to file...'
      OnExecute = actSaveDataSetExecute
    end
  end
