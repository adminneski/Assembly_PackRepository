...
{ TEhLibLanguageConsts }
  ...
  private
    ...
    FFilterListValuesLimitExceeded: String;
  ...
  published
    ...
    property FilterListValuesLimitExceeded: String read FFilterListValuesLimitExceeded write FFilterListValuesLimitExceeded;
  end;
...
begin
  ...
  CustomizeColumnsDialog := 'Customize columns ...';

  DBGridEhCustomizeColumnsDialog_VisibleColumns := 'Visible columns';
  DBGridEhCustomizeColumnsDialog_HiddenColumns := 'Hidden columns';
  DBGridEhCustomizeColumnsDialog_Caption := 'Columns setup';
  DBGridEhCustomizeColumnsDialog_ColumnName := 'Name';
  DBGridEhCustomizeColumnsDialog_ColumnWidth := 'Width';
  DBGridEhCustomizeColumnsDialog_SetWidth_Hint := 'Set width';
  DBGridEhCustomizeColumnsDialog_MoveUp_Hint := 'Move up';
  DBGridEhCustomizeColumnsDialog_MoveDown_Hint := 'Move down';
  DBGridEhCustomizeColumnsDialog_Hide_Hint := 'Hide';
  DBGridEhCustomizeColumnsDialog_Show_Hint := 'Show';
  DBGridEhCustomizeColumnsDialog_EnterNumericalValue := 'Enter a numerical value';
  DBGridEhCustomizeColumnsDialog_EnterColumnWidthS := 'Column width(s)';

  FilterListValuesLimitExceeded := 'Too many values selected.'#13#10'The number of selected values cannot exceed %d';
