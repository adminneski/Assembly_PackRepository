...
type
  ...
  TGobtStyle = (tsOffice2003Blue, tsOffice2003Silver, tsOffice2003Olive, tsOffice2003Classic,
    ...
    tsWindows10,
    tsOffice2016White, tsOffice2016Gray, tsOffice2016Black,tsNeski2018Claro,tsNeski2018Escuro,tsNeski2021Black);
  ...
  IGobtTones = interface
  ['{1F492643-6699-4F25-8B34-3233FA735036}']
     procedure SetColorTones(ATones: TColorTones);
  end;

  IGobtStyle = interface
  ['{11AC2DDC-C087-4298-AB6E-EA1B5017511B}']
    procedure SetComponentStyle(AStyle: TGobtStyle);
  end;

  IGobtStyleEx = interface(IGobtStyle)
  ['{037BA87F-7CBD-4FDD-854E-2B3F0BCC06AE}']
    procedure SetComponentStyle(AStyle: TGobtStyle);
    procedure SetComponentStyleAndAppColor(AStyle: TGobtStyle; AppColor: TColor);
  end;

  IGobtMetro = interface
