unit Gobt_DirSelected;
{$WARNINGS OFF}
{$HINTS OFF}

interface
  uses Windows, Messages, SysUtils, Variants, Classes,ShlObj, ActiveX,
  Vcl.Forms;
type
  TGoDirDialog = class(TComponent)
  protected
    FNewFolder: Boolean;
    FDirPath: String;
    FTitleName: String;
...
function TGoDirDialog.Execute: Boolean;
begin
  Result:= False;
  ...
  SelectDirectory(FTitleName, '', FDirPath, False, False, True);
end;
end.
