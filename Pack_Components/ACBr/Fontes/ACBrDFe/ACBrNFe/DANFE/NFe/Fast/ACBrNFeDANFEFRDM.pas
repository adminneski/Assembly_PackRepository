  ...
  begin
   ...
   begin
     ...
     begin
        ...
        FieldDefs.Add('Fax', ftString, 60);  //By Elaine / AP2
  ...
  begin
    ...
    begin
      ...
      cdsEmitente.FieldByName('DADOS_ENDERECO').AsString    := cdsEmitente.FieldByName('DADOS_ENDERECO').AsString + ' - ' +
                                                                ...
                                                                IfThen(trim(FDANFEClassOwner.Fax) <> '', ' - Cel: ' + FormatarFone(Trim(FDANFEClassOwner.Fax)),''); //By Elaine/AP2
...
begin
  ...
  begin
    ...
    FieldByName('Fax').AsString                         := IfThen( FDANFEClassOwner.Fax     <> '' , ' - FAX ' + FDANFEClassOwner.Fax , ''); //By Elaine/AP2
