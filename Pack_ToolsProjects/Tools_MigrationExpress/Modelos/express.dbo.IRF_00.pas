...
type
  [Entity]
  [Table('IRF_00', '')]
  [PrimaryKey('IRF_CODIGO', AutoInc, NoSort, False, 'Chave primária')]
  ...
  public 
    ...
    [Dictionary('IRF_TETOFINALINSS', 'Mensagem de validação', '0', '', '', taRightJustify)]
    ...
    [Dictionary('IRF_TETOINICIALINSS', 'Mensagem de validação', '0', '', '', taRightJustify)]
    ...
    [Dictionary('IRF_PARAMETROIRF', 'Mensagem de validação', '', '', '', taLeftJustify)]
    ...
    [Dictionary('IRF_PARAMETROINSS', 'Mensagem de validação', '', '', '', taLeftJustify)]
