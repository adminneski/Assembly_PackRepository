unit express.dbo.PRO_CONSULTAESTOQUERESERVA;
...
type
  [Entity]
  [Table('PRO_ConsultaEstoqueReserva', '')]
  TDtoPRO_ConsultaEstoqueReserva = class
  private
  ...
  public 
    { Public declarations } 
     const Table      = 'PRO_ConsultaEstoqueReserva';
...
initialization
  TRegisterClass.RegisterEntity(TDtoPRO_ConsultaEstoqueReserva)
