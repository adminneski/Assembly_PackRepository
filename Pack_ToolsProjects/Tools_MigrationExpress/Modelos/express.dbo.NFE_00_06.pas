...
type
  [Entity]
  [Table('NFE_00_06', '')]
  [PrimaryKey('NFE_06_ID', AutoInc, NoSort, False, 'Chave primária')]
  ...
  public
    ...
    [Dictionary('NFE_DC', 'Mensagem de validação', '', '', '', taLeftJustify)]
    ...
    [Dictionary('NFE_CENTROCUSTORATEIO', 'Mensagem de validação', '0', '', '', taRightJustify)]
