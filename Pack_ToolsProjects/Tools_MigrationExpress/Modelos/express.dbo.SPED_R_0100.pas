...
type
  ...
  public 
    { Public declarations } 
     const Table      = 'SPED_R_0100';

    [Restrictions([NoValidate, NotNull])]
    [Column('COD', ftInteger)]
    [Dictionary('COD', 'Mensagem de validação', '0', '', '', taCenter)]
...
initialization
  TRegisterClass.RegisterEntity(TDtoSPED_R_0100)
