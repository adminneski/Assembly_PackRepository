unit express.dbo.FAT_COMISSAOTECNICO;
...
type
  [Entity]
  [Table('FAT_ComissaoTecnico', '')]
  TDtoFAT_ComissaoTecnico = class
  private
  ...
  public 
    { Public declarations } 
     const Table      = 'FAT_ComissaoTecnico';
    ...
    [Restrictions([NoValidate])]
    [Column('FAT_TOTALSERVICO', ftBCD, 48, 7)]
    ...
    [Restrictions([NoValidate])]
    [Column('FAT_TOTALCOMISSAO', ftBCD, 48, 6)]
...
initialization
  TRegisterClass.RegisterEntity(TDtoFAT_ComissaoTecnico)
