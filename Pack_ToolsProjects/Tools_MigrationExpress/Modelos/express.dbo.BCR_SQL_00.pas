...
type
  ...
  public 
    ...
    [Restrictions([NoValidate, NotNull])]
    [Column('CRE_TOTALVALORBAIXALOTE', ftBCD, 1919250543, 2)]
...
initialization
  TRegisterClass.RegisterEntity(TDtoBCR_SQL_00)
