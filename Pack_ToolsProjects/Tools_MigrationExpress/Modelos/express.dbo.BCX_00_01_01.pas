...
type
  [Entity]
  [Table('BCX_00_01_01', '')]
  [PrimaryKey('BCX_01_01_ID', AutoInc, NoSort, False, 'Chave primária')]
  ...
  public
    ...
    [Dictionary('BCX_01_01_ID', 'Mensagem de validação', '0', '', '', taCenter)]
    ...
    [Dictionary('BCX_01_01_ID_OLD', 'Mensagem de validação', '0', '', '', taCenter)]
