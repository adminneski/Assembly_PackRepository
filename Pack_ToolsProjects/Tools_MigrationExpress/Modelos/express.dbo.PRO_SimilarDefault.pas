unit express.dbo.PRO_SIMILARDEFAULT;
...
type
  [Entity]
  [Table('PRO_SimilarDefault', '')]
  TDtoPRO_SimilarDefault = class
  private
  ...
  public 
    { Public declarations } 
     const Table      = 'PRO_SimilarDefault';
...
initialization
  TRegisterClass.RegisterEntity(TDtoPRO_SimilarDefault)
