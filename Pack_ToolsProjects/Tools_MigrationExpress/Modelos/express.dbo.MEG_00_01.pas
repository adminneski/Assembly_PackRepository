...
type
  [Entity]
  [Table('MEG_00_01', '')]
  [PrimaryKey('MEG_01_ID', AutoInc, NoSort, False, 'Chave primária')]
  [Sequence('SEQ_MEG_01_ID')]
  TDtoMEG_00_01 = class
  private
  ...
  public
    { Public declarations }
    const Table      = 'MEG_00_01';
    const PrimaryKey = 'MEG_01_ID';
    const Sequence   = 'SEQ_MEG_01_ID';
    ...
    [ForeignKey('MEG_00_01_fk', 'MEG_ID', 'MEG_00', 'MEG_ID', SetNull, SetNull)]
...
initialization
  TRegisterClass.RegisterEntity(TDtoMEG_00_01)
