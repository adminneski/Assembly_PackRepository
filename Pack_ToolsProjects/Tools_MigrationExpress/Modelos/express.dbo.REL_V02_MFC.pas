...
type
  ...
  private
    ...
    FPES_CODIGOSEGURADORA: Integer;
    FPES_NOMESEGURADORA: String;
  ...
  public 
    ...
    [Restrictions([NoValidate])]
    [Column('PES_DDD_CELULAR_1_TRP', ftString, 11)]
    [Dictionary('PES_DDD_CELULAR_1_TRP', 'Mensagem de validação', '', '', '', taLeftJustify)]
    property PES_DDD_CELULAR_1_TRP: String read FPES_DDD_CELULAR_1_TRP write FPES_DDD_CELULAR_1_TRP;
    const PES_DDD_CELULAR_1_TRP_Name = 'PES_DDD_CELULAR_1_TRP';
    ...
    [Restrictions([NoValidate])]
    [Column('PES_CODIGOSEGURADORA', ftInteger)]
    [Dictionary('PES_CODIGOSEGURADORA', 'Mensagem de validação', '0', '', '', taCenter)]
    property PES_CODIGOSEGURADORA: Integer read FPES_CODIGOSEGURADORA write FPES_CODIGOSEGURADORA;
    const PES_CODIGOSEGURADORA_Name = 'PES_CODIGOSEGURADORA';

    [Restrictions([NoValidate])]
    [Column('PES_NOMESEGURADORA', ftString, 100)]
    [Dictionary('PES_NOMESEGURADORA', 'Mensagem de validação', '', '', '', taLeftJustify)]
    property PES_NOMESEGURADORA: String read FPES_NOMESEGURADORA write FPES_NOMESEGURADORA;
    const PES_NOMESEGURADORA_Name = 'PES_NOMESEGURADORA';
    ...
    [Restrictions([NoValidate])]
    [Column('CTR_TOTALQTDVOLUMES', ftBCD, 10, 3)]
...
initialization
  TRegisterClass.RegisterEntity(TDtoREL_V02_MFC)
