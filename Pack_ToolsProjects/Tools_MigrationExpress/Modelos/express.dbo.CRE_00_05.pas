...
type
  [Entity]
  [Table('CRE_00_05', '')]
  [PrimaryKey('CRE_05_ID', AutoInc, NoSort, False, 'Chave primária')]
  [Sequence('SEQ_CRE_05_ID')]
  TDtoCRE_00_05 = class
  private
  ...
  public
    ...
    const Table      = 'CRE_00_05';
    const PrimaryKey = 'CRE_05_ID';
    const Sequence   = 'SEQ_CRE_05_ID';
    ...
    [ForeignKey('CRE_00_05_fk', 'CRE_ID', 'CRE_00', 'CRE_ID', SetNull, SetNull)]
    ...
    [Restrictions([NoValidate, NotNull])]
    [Column('CRE_CENTROCUSTORATEIO', ftBCD)]
    [Dictionary('CRE_CENTROCUSTORATEIO', 'Mensagem de validação', '0', '', '', taRightJustify)]
    property CRE_CENTROCUSTORATEIO: Double read FCRE_CENTROCUSTORATEIO write FCRE_CENTROCUSTORATEIO;
    const CRE_CENTROCUSTORATEIO_Name = 'CRE_CENTROCUSTORATEIO';
...
initialization
  TRegisterClass.RegisterEntity(TDtoCRE_00_05)
