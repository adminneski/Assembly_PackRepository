...
type
  ...
  public 
    ...
    [Restrictions([NoValidate, NotNull])]
    [Column('PRO_PRECOANTERIOR', ftBCD, 10, 2)]
    ...
    [Restrictions([NoValidate, NotNull])]
    [Column('PRO_QTDMINIMA', ftBCD, 48, 3)]
...
initialization
  TRegisterClass.RegisterEntity(TDtoPALM_V02_PRO)
