...
type
  ...
  private
    ...
    FFOR_CODIGO: Integer;
    FFOR_NOME: String;
    FETQ_ESTOQUERESERVA: Double;
    FPRO_PESOLIQUIDO: Double;
  public 
    { Public declarations } 
     const Table      = 'REL_V03_PRO';
    ...
    [Restrictions([NoValidate, NotNull])]
    [Column('ETQ_ESTOQUERESERVA', ftBCD)]
    [Dictionary('ETQ_ESTOQUERESERVA', 'Mensagem de validação', '0', '', '', taRightJustify)]
    property ETQ_ESTOQUERESERVA: Double read FETQ_ESTOQUERESERVA write FETQ_ESTOQUERESERVA;
    const ETQ_ESTOQUERESERVA_Name = 'ETQ_ESTOQUERESERVA';
...
initialization
  TRegisterClass.RegisterEntity(TDtoREL_V03_PRO)
