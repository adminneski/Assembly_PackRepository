...
type
  ...
  private
    ...
    FCGA_ID_OLD: Integer;
    FCRE_CREDITOUTILIZADOBAIXA: Double;
    FCRE_TIPOPARCELA: String;
    FCRE_IDCREDITO: Integer;
  public 
    { Public declarations } 
     const Table      = 'CRE_00';
    ...
    [Restrictions([NoValidate])]
    [Column('CRE_CREDITOUTILIZADOBAIXA', ftBCD)]
    [Dictionary('CRE_CREDITOUTILIZADOBAIXA', 'Mensagem de validação', '0', '', '', taRightJustify)]
    property CRE_CREDITOUTILIZADOBAIXA: Double read FCRE_CREDITOUTILIZADOBAIXA write FCRE_CREDITOUTILIZADOBAIXA;
    const CRE_CREDITOUTILIZADOBAIXA_Name = 'CRE_CREDITOUTILIZADOBAIXA';

    [Restrictions([NoValidate])]
    [Column('CRE_TIPOPARCELA', ftString, 1)]
    [Dictionary('CRE_TIPOPARCELA', 'Mensagem de validação', '', '', '', taLeftJustify)]
    property CRE_TIPOPARCELA: String read FCRE_TIPOPARCELA write FCRE_TIPOPARCELA;
    const CRE_TIPOPARCELA_Name = 'CRE_TIPOPARCELA';

    [Restrictions([NoValidate])]
    [Column('CRE_IDCREDITO', ftInteger)]
    [Dictionary('CRE_IDCREDITO', 'Mensagem de validação', '0', '', '', taCenter)]
    property CRE_IDCREDITO: Integer read FCRE_IDCREDITO write FCRE_IDCREDITO;
    const CRE_IDCREDITO_Name = 'CRE_IDCREDITO';
  end;

implementation

initialization
  TRegisterClass.RegisterEntity(TDtoCRE_00)
