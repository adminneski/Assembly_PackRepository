unit express.dbo.XML_CTE_00_01;
...
type
  ...
  public
    ...
    [ForeignKey('XML_CTE_00_01_fk', 'XML_ID', 'XML_CTE_00', 'XML_ID', SetNull, SetNull)]
...
initialization
  TRegisterClass.RegisterEntity(TDtoXML_CTE_00_01)
