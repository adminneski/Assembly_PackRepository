...
type
  ...
  private
    ...
    FVL_BC_ICMS: Double;
    FVL_ICMS: Double;
    FVL_BC_ICMS_UF: Integer;
    FVL_ICMS_UF: Integer;
    FVL_RED_BC: Double;
    FCOD_OBS: String;
  public 
    { Public declarations } 
     const Table      = 'SPED_R_D590';
    ...
    [Restrictions([NoValidate, NotNull])]
    [Column('VL_BC_ICMS_UF', ftInteger)]
    [Dictionary('VL_BC_ICMS_UF', 'Mensagem de validação', '0', '', '', taCenter)]
    property VL_BC_ICMS_UF: Integer read FVL_BC_ICMS_UF write FVL_BC_ICMS_UF;
    const VL_BC_ICMS_UF_Name = 'VL_BC_ICMS_UF';

    [Restrictions([NoValidate, NotNull])]
    [Column('VL_ICMS_UF', ftInteger)]
    [Dictionary('VL_ICMS_UF', 'Mensagem de validação', '0', '', '', taCenter)]
    property VL_ICMS_UF: Integer read FVL_ICMS_UF write FVL_ICMS_UF;
    const VL_ICMS_UF_Name = 'VL_ICMS_UF';

    [Restrictions([NoValidate, NotNull])]
    [Column('VL_RED_BC', ftBCD)]
    [Dictionary('VL_RED_BC', 'Mensagem de validação', '0', '', '', taRightJustify)]
...
initialization
  TRegisterClass.RegisterEntity(TDtoSPED_R_D590)
