unit express.dbo.SPEDPC_R_C195;
...
type
  ...
  public 
    ...
    [Restrictions([NoValidate])]
    [Column('CNPJ_CPF_PART', ftString, 14)]
    [Dictionary('CNPJ_CPF_PART', 'Mensagem de validação', '', '', '', taLeftJustify)]
    property CNPJ_CPF_PART: String read FCNPJ_CPF_PART write FCNPJ_CPF_PART;
    const CNPJ_CPF_PART_Name = 'CNPJ_CPF_PART';
...
initialization
  TRegisterClass.RegisterEntity(TDtoSPEDPC_R_C195)
