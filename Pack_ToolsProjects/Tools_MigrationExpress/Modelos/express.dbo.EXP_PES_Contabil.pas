unit express.dbo.EXP_PES_CONTABIL;
...
type
  [Entity]
  [Table('EXP_PES_Contabil', '')]
  TDtoEXP_PES_Contabil = class
  private
...
initialization
  TRegisterClass.RegisterEntity(TDtoEXP_PES_Contabil)
