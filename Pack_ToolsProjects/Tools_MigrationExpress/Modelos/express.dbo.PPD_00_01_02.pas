...
type
  [Entity]
  [Table('PPD_00_01_02', '')]
  [PrimaryKey('PPD_01_02_ID', AutoInc, NoSort, False, 'Chave primária')]
  [Sequence('SEQ_PPD_01_02_ID')]
  TDtoPPD_00_01_02 = class
  private
    { Private declarations } 
    FPPD_01_02_ID: Integer;
    FCOM_CODIGO: Integer;
    FPPD_01_ID: Integer;
    FPPD_ID: Integer;
    FPRO_CODIGO: Integer;
    ...
    FPPD_01_02_ID_OLD: Integer;
    FPPD_01_ID_OLD: Integer;
    FPPD_ID_OLD: Integer;
  public
    { Public declarations }
    const Table      = 'PPD_00_01_02';
    const PrimaryKey = 'PPD_01_02_ID';
    const Sequence   = 'SEQ_PPD_01_02_ID';

    [Restrictions([NoValidate, NotNull])]
    [Column('PPD_01_02_ID', ftInteger)]
    [Dictionary('PPD_01_02_ID', 'Mensagem de validação', '0', '', '', taCenter)]
    property PPD_01_02_ID: Integer read FPPD_01_02_ID write FPPD_01_02_ID;
    const PPD_01_02_ID_Name = 'PPD_01_02_ID';
    ...
    [ForeignKey('PPD_00_01_02_fk', 'PPD_ID', 'PPD_00', 'PPD_ID', SetNull, SetNull)]
    ...
    [Restrictions([NoValidate])]
    [Column('PPD_01_02_ID_OLD', ftInteger)]
    [Dictionary('PPD_01_02_ID_OLD', 'Mensagem de validação', '0', '', '', taCenter)]
    property PPD_01_02_ID_OLD: Integer read FPPD_01_02_ID_OLD write FPPD_01_02_ID_OLD;
    const PPD_01_02_ID_OLD_Name = 'PPD_01_02_ID_OLD';
...
initialization
  TRegisterClass.RegisterEntity(TDtoPPD_00_01_02)
