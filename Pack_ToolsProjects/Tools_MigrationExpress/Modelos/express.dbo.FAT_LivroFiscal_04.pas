unit express.dbo.FAT_LIVROFISCAL_04;
...
type
  [Entity]
  [Table('FAT_LivroFiscal_04', '')]
  TDtoFAT_LivroFiscal_04 = class
  private
  ...
  public 
    { Public declarations } 
     const Table      = 'FAT_LivroFiscal_04';
...
initialization
  TRegisterClass.RegisterEntity(TDtoFAT_LivroFiscal_04)
