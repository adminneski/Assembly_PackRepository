unit express.dbo.FAT_LISTAPRODUTOS;
...
type
  [Entity]
  [Table('FAT_ListaProdutos', '')]
  TDtoFAT_ListaProdutos = class
  private
  ...
  public 
    ...
    [Restrictions([NoValidate])]
    [Column('PRO_PRECOTABELA', ftBCD, 48, 2)]
...
initialization
  TRegisterClass.RegisterEntity(TDtoFAT_ListaProdutos)
