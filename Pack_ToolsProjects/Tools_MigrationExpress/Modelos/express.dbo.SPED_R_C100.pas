...
type
  ...
  private
    ...
    FVL_COFINS: Double;
    FVL_PIS_ST: Integer;
    FVL_COFINS_ST: Integer;
  public 
    { Public declarations } 
     const Table      = 'SPED_R_C100';
    ...
    [Restrictions([NoValidate, NotNull])]
    [Column('VL_PIS_ST', ftInteger)]
    [Dictionary('VL_PIS_ST', 'Mensagem de validação', '0', '', '', taCenter)]
    property VL_PIS_ST: Integer read FVL_PIS_ST write FVL_PIS_ST;
    const VL_PIS_ST_Name = 'VL_PIS_ST';

    [Restrictions([NoValidate, NotNull])]
    [Column('VL_COFINS_ST', ftInteger)]
    [Dictionary('VL_COFINS_ST', 'Mensagem de validação', '0', '', '', taCenter)]
    property VL_COFINS_ST: Integer read FVL_COFINS_ST write FVL_COFINS_ST;
...
initialization
  TRegisterClass.RegisterEntity(TDtoSPED_R_C100)
