...
type
  [Entity]
  [Table('ETQ_00_01', '')]
  [PrimaryKey('ETQ_01_ID', AutoInc, NoSort, False, 'Chave primária')]
  [Sequence('SEQ_ETQ_01_ID')]
  TDtoETQ_00_01 = class
  private
    ...
    FETQ_01_ID_OLD: Integer;
  public 
    { Public declarations } 
     const Table      = 'ETQ_00_01';
     const PrimaryKey = 'ETQ_01_ID';
     const Sequence   = 'SEQ_ETQ_01_ID';

    [Restrictions([NoValidate, NotNull])]
    [Column('ETQ_01_ID', ftInteger)]
    [Dictionary('ETQ_01_ID', 'Mensagem de validação', '0', '', '', taCenter)]
    property ETQ_01_ID: Integer read FETQ_01_ID write FETQ_01_ID;
    const ETQ_01_ID_Name = 'ETQ_01_ID';
    ...
    [Restrictions([NoValidate])]
    [Column('ETQ_01_ID_OLD', ftInteger)]
    [Dictionary('ETQ_01_ID_OLD', 'Mensagem de validação', '0', '', '', taCenter)]
    property ETQ_01_ID_OLD: Integer read FETQ_01_ID_OLD write FETQ_01_ID_OLD;
    const ETQ_01_ID_OLD_Name = 'ETQ_01_ID_OLD';
  end;

implementation

initialization
  TRegisterClass.RegisterEntity(TDtoETQ_00_01)
