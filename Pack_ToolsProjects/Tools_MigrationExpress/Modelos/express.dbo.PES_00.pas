...
type
  ...
  private
    ...
    FPES_MONTANTEABERTO: Double;
    FPES_MONTANTEFECHADO: Double;
    FPES_NUMEROCRC: String;
    FPES_CONTROLAESTOQUEPRODUTOR: String;
    FPES_RNTRC: String;
    FPES_BLOQUEADO: String;
    FPES_OBSERVACAOBLOQUEIO: TBlob;
    FPES_EMAIL: String;
    FPES_EMAILXML: String;
    FPES_CONSUMIDORFINAL: String;
    ...
    FPES_CNPJ_CONTABILIDADE: String;
    FPES_NOMEPAI: String;
    FPES_NOMEMAE: String;
    FTRP_CODIGO: Integer;
    FSEG_CODIGO: Integer;
    ...
    FPES_INFORMACAOBANCARIA: TBlob;
    FPES_INFORMACAOAUTORIZADOS: TBlob;
    FPES_NOMECONJUGE: String;
    FPES_CPF_CONJUGE: String;
    FPES_CI_CONJUGE: String;
    ...
    FPES_PAIS: String;
    FPES_GUID: String;
    FTAB_CODIGOVENDEDOR: Integer;
    FPES_NUMEROALVARASANITARIO: String;
    FPES_DATAALVARASANITARIO: TDateTime;
    FPES_DATAFUNDACAO: TDateTime;
    FPES_STATUS: String;
    FCOM_CODIGO: Integer;
    FCOM_CODIGO_INTEGRACAO_AUTHENTICATOR: Integer;
    FLEF_CODIGO: Integer;
    FPES_EMAILNOTIFICACAOENVIADO: String;
  public 
    { Public declarations } 
     const Table      = 'PES_00';
    ...
    [Restrictions([NoValidate, NotNull])]
    [Column('PES_MONTANTEABERTO', ftBCD, 1146045279, 2)]
    [Dictionary('PES_MONTANTEABERTO', 'Mensagem de validação', '0', '', '', taRightJustify)]
    property PES_MONTANTEABERTO: Double read FPES_MONTANTEABERTO write FPES_MONTANTEABERTO;
    const PES_MONTANTEABERTO_Name = 'PES_MONTANTEABERTO';

    [Restrictions([NoValidate, NotNull])]
    [Column('PES_MONTANTEFECHADO', ftBCD, 1195983951, 2)]
    [Dictionary('PES_MONTANTEFECHADO', 'Mensagem de validação', '0', '', '', taRightJustify)]
    property PES_MONTANTEFECHADO: Double read FPES_MONTANTEFECHADO write FPES_MONTANTEFECHADO;
    const PES_MONTANTEFECHADO_Name = 'PES_MONTANTEFECHADO';
    ...
    [Restrictions([NoValidate])]
    [Column('PES_OBSERVACAOBLOQUEIO', ftBlob)]
    [Dictionary('PES_OBSERVACAOBLOQUEIO', 'Mensagem de validação', '', '', '', taLeftJustify)]
    property PES_OBSERVACAOBLOQUEIO: TBlob read FPES_OBSERVACAOBLOQUEIO write FPES_OBSERVACAOBLOQUEIO;
    const PES_OBSERVACAOBLOQUEIO_Name = 'PES_OBSERVACAOBLOQUEIO';
    ...
    [Restrictions([NoValidate])]
    [Column('PES_CONSUMIDORFINAL', ftString, 1)]
    [Dictionary('PES_CONSUMIDORFINAL', 'Mensagem de validação', '', '', '', taLeftJustify)]
    property PES_CONSUMIDORFINAL: String read FPES_CONSUMIDORFINAL write FPES_CONSUMIDORFINAL;
    const PES_CONSUMIDORFINAL_Name = 'PES_CONSUMIDORFINAL';
    ...
    [Restrictions([NoValidate])]
    [Column('PES_CNPJ_CONTABILIDADE', ftString, 14)]
    [Dictionary('PES_CNPJ_CONTABILIDADE', 'Mensagem de validação', '', '', '', taLeftJustify)]
    property PES_CNPJ_CONTABILIDADE: String read FPES_CNPJ_CONTABILIDADE write FPES_CNPJ_CONTABILIDADE;
    const PES_CNPJ_CONTABILIDADE_Name = 'PES_CNPJ_CONTABILIDADE';
    ...
    [Restrictions([NoValidate])]
    [Column('PES_INFORMACAOBANCARIA', ftBlob)]
    [Dictionary('PES_INFORMACAOBANCARIA', 'Mensagem de validação', '', '', '', taLeftJustify)]
    property PES_INFORMACAOBANCARIA: TBlob read FPES_INFORMACAOBANCARIA write FPES_INFORMACAOBANCARIA;
    const PES_INFORMACAOBANCARIA_Name = 'PES_INFORMACAOBANCARIA';
    ...
    [Restrictions([NoValidate])]
    [Column('PES_CPF_CONJUGE', ftString, 11)]
    [Dictionary('PES_CPF_CONJUGE', 'Mensagem de validação', '', '', '', taLeftJustify)]
    property PES_CPF_CONJUGE: String read FPES_CPF_CONJUGE write FPES_CPF_CONJUGE;
    const PES_CPF_CONJUGE_Name = 'PES_CPF_CONJUGE';

    [Restrictions([NoValidate])]
    [Column('PES_CI_CONJUGE', ftString, 16)]
    [Dictionary('PES_CI_CONJUGE', 'Mensagem de validação', '', '', '', taLeftJustify)]
    property PES_CI_CONJUGE: String read FPES_CI_CONJUGE write FPES_CI_CONJUGE;
    const PES_CI_CONJUGE_Name = 'PES_CI_CONJUGE';
    ...
    [Restrictions([NoValidate])]
    [Column('PES_PERCENTUALLIMITEDESCONTO', ftBCD, 1280335696, 2)]
    ...
    [Restrictions([NoValidate])]
    [Column('PES_PERCENTUALDESCTOBOLETO', ftBCD, 1599096398, 2)]
    ...
    [Restrictions([NoValidate])]
    [Column('PES_LIMITECREDITO', ftBCD, 1142962771, 2)]
    ...
    [Restrictions([NoValidate])]
    [Column('PES_LIMITECOMPRA', ftBCD, 1415532614, 2)]
    ...
    [Restrictions([NoValidate])]
    [Column('PES_GUID', ftString, 38)]
    [Dictionary('PES_GUID', 'Mensagem de validação', '', '', '', taLeftJustify)]
    property PES_GUID: String read FPES_GUID write FPES_GUID;
    const PES_GUID_Name = 'PES_GUID';

    [Restrictions([NoValidate])]
    [Column('TAB_CODIGOVENDEDOR', ftInteger)]
    [Dictionary('TAB_CODIGOVENDEDOR', 'Mensagem de validação', '0', '', '', taCenter)]
    property TAB_CODIGOVENDEDOR: Integer read FTAB_CODIGOVENDEDOR write FTAB_CODIGOVENDEDOR;
    const TAB_CODIGOVENDEDOR_Name = 'TAB_CODIGOVENDEDOR';

    [Restrictions([NoValidate])]
    [Column('PES_NUMEROALVARASANITARIO', ftString, 15)]
    [Dictionary('PES_NUMEROALVARASANITARIO', 'Mensagem de validação', '', '', '', taLeftJustify)]
    property PES_NUMEROALVARASANITARIO: String read FPES_NUMEROALVARASANITARIO write FPES_NUMEROALVARASANITARIO;
    const PES_NUMEROALVARASANITARIO_Name = 'PES_NUMEROALVARASANITARIO';

    [Restrictions([NoValidate])]
    [Column('PES_DATAALVARASANITARIO', ftDateTime)]
    [Dictionary('PES_DATAALVARASANITARIO', 'Mensagem de validação', '', '', '', taCenter)]
    property PES_DATAALVARASANITARIO: TDateTime read FPES_DATAALVARASANITARIO write FPES_DATAALVARASANITARIO;
    const PES_DATAALVARASANITARIO_Name = 'PES_DATAALVARASANITARIO';

    [Restrictions([NoValidate])]
    [Column('PES_DATAFUNDACAO', ftDateTime)]
    [Dictionary('PES_DATAFUNDACAO', 'Mensagem de validação', '', '', '', taCenter)]
    property PES_DATAFUNDACAO: TDateTime read FPES_DATAFUNDACAO write FPES_DATAFUNDACAO;
    const PES_DATAFUNDACAO_Name = 'PES_DATAFUNDACAO';

    [Restrictions([NoValidate])]
    [Column('PES_STATUS', ftString, 1)]
    [Dictionary('PES_STATUS', 'Mensagem de validação', '', '', '', taLeftJustify)]
    property PES_STATUS: String read FPES_STATUS write FPES_STATUS;
    const PES_STATUS_Name = 'PES_STATUS';
    ...
    [Restrictions([NoValidate])]
    [Column('PES_EMAILNOTIFICACAOENVIADO', ftString, 1)]
    [Dictionary('PES_EMAILNOTIFICACAOENVIADO', 'Mensagem de validação', '', '', '', taLeftJustify)]
    property PES_EMAILNOTIFICACAOENVIADO: String read FPES_EMAILNOTIFICACAOENVIADO write FPES_EMAILNOTIFICACAOENVIADO;
    const PES_EMAILNOTIFICACAOENVIADO_Name = 'PES_EMAILNOTIFICACAOENVIADO';
  end;

implementation

initialization
  TRegisterClass.RegisterEntity(TDtoPES_00)
