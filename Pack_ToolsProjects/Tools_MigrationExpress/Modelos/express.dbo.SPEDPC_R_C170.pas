unit express.dbo.SPEDPC_R_C170;
...
type
  ...
  public 
    ...
    [Restrictions([NoValidate])]
    [Column('VL_BC_COFINS', ftBCD, 48, 2)]
...
initialization
  TRegisterClass.RegisterEntity(TDtoSPEDPC_R_C170)
