unit express.dbo.XML_MDFE_00_01;
...
type
  ...
  public
    ...
    [ForeignKey('XML_MDFE_00_01_fk', 'XML_ID', 'XML_MDFE_00', 'XML_ID', SetNull, SetNull)]
...
initialization
  TRegisterClass.RegisterEntity(TDtoXML_MDFE_00_01)
