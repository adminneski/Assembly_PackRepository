...
type
  ...
  public 
    ...
    [Dictionary('XML_XMLMANIFESTO', 'Mensagem de validação', '', '', '', taLeftJustify)]
    ...
    [Dictionary('XML_XMLMANIFESTOCOMAUTORIZ', 'Mensagem de validação', '', '', '', taLeftJustify)]
    ...
    [Dictionary('XML_LOTE_MDFE', 'Mensagem de validação', '0', '', '', taCenter)]
    ...
    [Dictionary('XML_PROTOCOLOENCERRAMENTO', 'Mensagem de validação', '', '', '', taLeftJustify)]
    ...
    [Dictionary('XML_DATAHORAENCERRAMENTO', 'Mensagem de validação', '', '', '', taCenter)]
    ...
    [Dictionary('XML_XMLENCERRAMENTO', 'Mensagem de validação', '', '', '', taLeftJustify)]
    ...
    [Dictionary('XML_DATAENCERRAMENTO', 'Mensagem de validação', '', '', '', taCenter)]
    ...
    [Dictionary('XML_HORAENCERRAMENTO', 'Mensagem de validação', '', '', '', taLeftJustify)]
