unit express.dbo.LIC_CONSULTANLICENCA;
...
type
  [Entity]
  [Table('LIC_ConsultaNLicenca', '')]
  TDtoLIC_ConsultaNLicenca = class
  private
  ...
  public 
    { Public declarations } 
     const Table      = 'LIC_ConsultaNLicenca';
...
initialization
  TRegisterClass.RegisterEntity(TDtoLIC_ConsultaNLicenca)
