...
type
  ...
  private
    ...
    FXML_XMLCONHECIMENTO: TBlob;
    FXML_XMLCONHECIMENTOCOMAUTORIZ: TBlob;
  ...
  public 
    ...
    [Column('XML_VERSAO', ftBCD, 1919250543, 2)]
    ...
    [Restrictions([NoValidate])]
    [Column('XML_XMLCONHECIMENTO', ftBlob)]
    [Dictionary('XML_XMLCONHECIMENTO', 'Mensagem de validação', '', '', '', taLeftJustify)]
    property XML_XMLCONHECIMENTO: TBlob read FXML_XMLCONHECIMENTO write FXML_XMLCONHECIMENTO;
    const XML_XMLCONHECIMENTO_Name = 'XML_XMLCONHECIMENTO';

    [Restrictions([NoValidate])]
    [Column('XML_XMLCONHECIMENTOCOMAUTORIZ', ftBlob)]
    [Dictionary('XML_XMLCONHECIMENTOCOMAUTORIZ', 'Mensagem de validação', '', '', '', taLeftJustify)]
    property XML_XMLCONHECIMENTOCOMAUTORIZ: TBlob read FXML_XMLCONHECIMENTOCOMAUTORIZ write FXML_XMLCONHECIMENTOCOMAUTORIZ;
    const XML_XMLCONHECIMENTOCOMAUTORIZ_Name = 'XML_XMLCONHECIMENTOCOMAUTORIZ';
    ...
    [Dictionary('XML_TOMADOR', 'Mensagem de validação', '0', '', '', taCenter)]
...
initialization
  TRegisterClass.RegisterEntity(TDtoXML_CTE_00)
