...
type
  [Entity]
  [Table('OMF_00_06_01', '')]
  [PrimaryKey('OMF_06_01_ID', AutoInc, NoSort, False, 'Chave primária')]
  [Sequence('SEQ_OMF_06_01_ID')]
  TDtoOMF_00_06_01 = class
  private
    { Private declarations } 
    FOMF_06_01_ID: Integer;
    FCOM_CODIGO: Integer;
    FOMF_ID: Integer;
    FOMF_06_ID: Integer;
    FPLC_CODIGO: Integer;
    ...
    FOMF_06_01_ID_OLD: Integer;
    FOMF_06_ID_OLD: Integer;
    FOMF_ID_OLD: Integer;
  public
    { Public declarations }
    const Table      = 'OMF_00_06_01';
    const PrimaryKey = 'OMF_06_01_ID';
    const Sequence   = 'SEQ_OMF_06_01_ID';

    [Restrictions([NoValidate, NotNull])]
    [Column('OMF_06_01_ID', ftInteger)]
    [Dictionary('OMF_06_01_ID', 'Mensagem de validação', '0', '', '', taCenter)]
    property OMF_06_01_ID: Integer read FOMF_06_01_ID write FOMF_06_01_ID;
    const OMF_06_01_ID_Name = 'OMF_06_01_ID';
    ...
    [ForeignKey('OMF_00_06_01_fk', 'OMF_ID', 'OMF_00', 'OMF_ID', SetNull, SetNull)]
    ...
    [Restrictions([NoValidate])]
    [Column('OMF_06_01_ID_OLD', ftInteger)]
    [Dictionary('OMF_06_01_ID_OLD', 'Mensagem de validação', '0', '', '', taCenter)]
    property OMF_06_01_ID_OLD: Integer read FOMF_06_01_ID_OLD write FOMF_06_01_ID_OLD;
    const OMF_06_01_ID_OLD_Name = 'OMF_06_01_ID_OLD';
...
initialization
  TRegisterClass.RegisterEntity(TDtoOMF_00_06_01)
