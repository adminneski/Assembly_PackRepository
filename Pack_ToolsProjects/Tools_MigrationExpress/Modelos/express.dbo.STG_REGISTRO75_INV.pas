unit express.dbo.STG_REGISTRO75_INV;
...
type
  [Entity]
  [Table('STG_REGISTRO75_INV', '')]
  TDtoSTG_REGISTRO75_INV = class
  private
  ...
  public 
    { Public declarations } 
     const Table      = 'STG_REGISTRO75_INV';
...
initialization
  TRegisterClass.RegisterEntity(TDtoSTG_REGISTRO75_INV)
