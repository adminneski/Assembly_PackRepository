unit express.dbo.CGA_RETORNOFINANCEIRO;
...
type
  [Entity]
  [Table('CGA_RetornoFinanceiro', '')]
  TDtoCGA_RetornoFinanceiro = class
  private
  ...
  public 
    { Public declarations } 
     const Table      = 'CGA_RetornoFinanceiro';
    ...
    [Restrictions([NoValidate, NotNull])]
    [Column('FAT_TOTALLIQUIDO', ftBCD, 16387, 2)]
...
initialization
  TRegisterClass.RegisterEntity(TDtoCGA_RetornoFinanceiro)
