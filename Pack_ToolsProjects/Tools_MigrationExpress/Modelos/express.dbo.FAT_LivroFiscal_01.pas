unit express.dbo.FAT_LIVROFISCAL_01;
...
type
  [Entity]
  [Table('FAT_LivroFiscal_01', '')]
  TDtoFAT_LivroFiscal_01 = class
  private
  ...
  public 
    { Public declarations } 
     const Table      = 'FAT_LivroFiscal_01';
    ...
    [Restrictions([NoValidate])]
    [Column('FAT_VALORBASECALCULOICMSITEM', ftBCD, 48, 2)]
    ...
    [Restrictions([NoValidate])]
    [Column('FAT_VALORICMSRITEM', ftBCD, 10, 2)]
...
initialization
  TRegisterClass.RegisterEntity(TDtoFAT_LivroFiscal_01)
