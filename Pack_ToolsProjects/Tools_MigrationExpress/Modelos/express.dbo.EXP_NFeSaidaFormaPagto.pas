unit express.dbo.EXP_NFESAIDAFORMAPAGTO;
...
type
  [Entity]
  [Table('EXP_NFeSaidaFormaPagto', '')]
  TDtoEXP_NFeSaidaFormaPagto = class
  private
  ...
  public 
    { Public declarations } 
     const Table      = 'EXP_NFeSaidaFormaPagto';
...
initialization
  TRegisterClass.RegisterEntity(TDtoEXP_NFeSaidaFormaPagto)
