unit express.dbo.SPEDPC_R_C010;
...
type
  ...
  public 
    ...
    [Restrictions([NoValidate])]
    [Column('IND_ESCRI', ftString, 1)]
    [Dictionary('IND_ESCRI', 'Mensagem de validação', '', '', '', taLeftJustify)]
    property IND_ESCRI: String read FIND_ESCRI write FIND_ESCRI;
    const IND_ESCRI_Name = 'IND_ESCRI';
  end;

implementation

initialization
  TRegisterClass.RegisterEntity(TDtoSPEDPC_R_C010)
